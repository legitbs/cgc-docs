...
For information regarding the building a CB, see the [building-a-cb.md][1] walk-through

For information regarding using the cb-server, see [man cb-server(1)][2]
